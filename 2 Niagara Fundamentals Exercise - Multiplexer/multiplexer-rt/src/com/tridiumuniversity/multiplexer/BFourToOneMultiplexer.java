...
@NiagaraType
@NiagaraProperty( name = "in0", type = "BBoolean", defaultValue = "BBoolean.DEFAULT", flags = Flags.SUMMARY )
@NiagaraProperty( name = "in1", type = "BBoolean", defaultValue = "BBoolean.DEFAULT", flags = Flags.SUMMARY )
@NiagaraProperty( name = "in2", type = "BBoolean", defaultValue = "BBoolean.DEFAULT", flags = Flags.SUMMARY )
@NiagaraProperty( name = "in3", type = "BBoolean", defaultValue = "BBoolean.DEFAULT", flags = Flags.SUMMARY )
@NiagaraProperty( name = "s0", type = "BBoolean", defaultValue = "BBoolean.DEFAULT", flags = Flags.SUMMARY )
...
/* Generated Tue Mar 24 17:03:40 EDT 2026 by Slot-o-Matic (c) Tridium, Inc. 2012-2026 */
   ...
   * @see #setIn0
   */
  public static final Property in0 = newProperty(Flags.SUMMARY, BBoolean.DEFAULT.as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setIn1
   */
  public static final Property in1 = newProperty(Flags.SUMMARY, BBoolean.DEFAULT.as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setIn2
   */
  public static final Property in2 = newProperty(Flags.SUMMARY, BBoolean.DEFAULT.as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setIn3
   */
  public static final Property in3 = newProperty(Flags.SUMMARY, BBoolean.DEFAULT.as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setS0
   */
  public static final Property s0 = newProperty(Flags.SUMMARY, BBoolean.DEFAULT.as(BBoolean.class).getBoolean(), null);
   ...
   * @see #setS1
   */
  public static final Property s1 = newProperty(Flags.SUMMARY, BBoolean.DEFAULT.as(BBoolean.class).getBoolean(), null);
  ...
  public static final Type TYPE = Sys.loadType(BFourToOneMultiplexer.class);
