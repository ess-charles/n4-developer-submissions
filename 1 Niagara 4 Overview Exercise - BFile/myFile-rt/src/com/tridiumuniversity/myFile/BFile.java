...
/* Generated Thu Mar 26 12:51:24 EDT 2026 by Slot-o-Matic (c) Tridium, Inc. 2012-2026 */
   ...
   * @see #setSize
   */
  public static final Property size = newProperty(0, BInteger.DEFAULT.as(BInteger.class).getInt(), null);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  ...
  public void doPrint() {
    System.out.println("File: " + getFileName() + ", Path: " + getPath() + ", Size: " + getSize() + ", Created: " + getCreatedDate() + ", Modified: " + getModifiedDate());
  }
}
